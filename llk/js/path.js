...
llk.success = function(){
	...
	llk.score += document.getElementById("time_count").style.pixelWidth;
...
llk.game = function(){
	...
	time_count.style.pixelWidth = 450;
	time_count.style.pixelHeight = 13;
	llk.count();
...
llk.addTime = function(){	
	var time_count = document.getElementById("time_count");
	var counts = time_count.style.pixelWidth;
	if(time_count.style.pixelWidth<447){
		time_count.style.pixelWidth += 3;
	}
	if(counts>350)
	{
		time_count.src = "/images/llk/count1.gif";
...
llk.count = function(){
	...
	llk.timeid = setInterval(function(){
		var counts = time_count.style.pixelWidth;
		time_count.style.pixelWidth = counts-1;
		switch (counts){
			case 350:
				time_count.src = "/images/llk/count2.gif";
				break;
