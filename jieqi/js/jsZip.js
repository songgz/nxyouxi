 ...
 ***********/
var deleSpaceN = 10000000;
//delSpace()有效执行次数(用于调试压缩后的程序)
...
function getLine() {
	...
	//缓存中读入一行,read()会读换行符,所以遇至换行符就不再循环
...
ph = ph.substr(0, ph.lastIndexOf("\\") + 1);
//当前路径
...
deleSpaceN = args.item(3) - 0;
//设置压缩的段落数(一个字串看作段落的分界符),调试用
